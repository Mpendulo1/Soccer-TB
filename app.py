...
# creating a table for user admin
    ...
    def player_profile(self):
        with sqlite3.connect('football.db') as conn:
            conn.execute("CREATE TABLE IF NOT EXISTS player_profile(player_id INTEGER PRIMARY KEY AUTOINCREMENT,"
                         "firstname TEXT NOT NULL,"
                         "lastname TEXT NOT NULL,"
...
def player_registraion():
    ...
    with sqlite3.connect('football.db') as conn:
        cursor = conn.cursor()
        cursor.execute("INSERT INTO player_profile("
                       "firstname,"
                       "lastname,"
                       "nickname,"
                       "age,"
...
def scouter_profile():
    ...
    with sqlite3.connect('football.db') as conn:
        ...
        cursor.execute("INSERT INTO scouter_profile (firstname,"
                       ...
                       "age,"
                       "nationality,"
                       "image) VALUES(?, ?, ?, ?, ?, ?, ?)", (firstname, lastname, phonenumber, email, age, nationality, image))
        ...
        with sqlite3.connect('football.db') as conn:
            ...
            if incoming_data.get('firstname') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE user SET firstname=? WHERE userId='" + str(userId) + "'", ([put_data['firstname']]))
                    conn.commit()
                    response['message'] = "FirstName Updated Successfully"
                    response['status_code'] = 200
            ...
            if incoming_data.get('lastname') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE user SET lastname=? WHERE userId='" + str(userId) + "'", ([put_data['lastname']]))
                    conn.commit()
            ...
            if incoming_data.get('phone') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE user SET phone=? WHERE userId='" + str(userId) + "'", ([put_data['phone']]))
                    conn.commit()
            ...
            if incoming_data.get('email') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE user SET email=? WHERE userId='"+ str(userId) + "'", ([put_data['email']]))
                    conn.commit()
            ...
            if incoming_data.get('password') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE user SET password=? WHERE userId='" + str(userId) + "'", ([put_data['password']]))
                    conn.commit()
        ...
        with sqlite3.connect('football.db') as conn:
            ...
            if incoming_data.get('firstname') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE player_profile SET firstname=? WHERE player_id='" + str(player_id) + "'", ([put_data['firstname']]))
                    conn.commit()
            ...
            if incoming_data.get('lastname') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE player_profile SET lastname=? WHERE player_id='" + str(player_id) + "'", ([put_data['lastname']]))
                    conn.commit()
                    response['message'] = "lastname Updated Successfully"
                    response['status_code'] = 200
                return response
            ...
            if incoming_data.get('nickname') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE player_profile SET nickname=? WHERE player_id='" + str(player_id) + "'", ([put_data['nickname']]))
                    conn.commit()
            ...
            if incoming_data.get('age') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE player_profile SET age=? WHERE player_id='" + str(player_id) + "'", ([put_data['age']]))
                    conn.commit()
            ...
            if incoming_data.get('gender') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE player_profile SET gender=? WHERE player_id='" + str(player_id) + "'", ([put_data['gender']]))
                    conn.commit()
            ...
            if incoming_data.get('date_of_birth') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET date_of_birth=? WHERE player_id='" + str(player_id) + "'", ([put_data['date_of_birth']]))
                    conn.commit()
                    response['message'] = "Date of Birth Updated Successfully"
                    response['status_code'] = 200
                return response
            ...
            if incoming_data.get('place_of_birth') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET place_of_birth=? WHERE player_id='" + str(player_id) + "'", ([put_data['place_of_birth']]))
                    conn.commit()
                    response['message'] = "Place Of Birth Updated Successfully"
                    response['status_code'] = 200
            ...
            if incoming_data.get('home_address') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET home_address=? WHERE player_id='" + str(player_id) + "'", ([put_data['home_address']]))
                    conn.commit()
            ...
            if incoming_data.get('nationality') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET nationality=? WHERE player_id='" + str(player_id) + "'", ([put_data['nationality']]))
                    conn.commit()
            ...
            if incoming_data.get('player_position') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET player_position=? WHERE player_id='" + str(player_id) + "'", ([put_data['nickname']]))
                    conn.commit()
            ...
            if incoming_data.get('height') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE player_profile SET height=? WHERE player_id='" + str(player_id) + "'", ([put_data['height']]))
                    conn.commit()
            ...
            if incoming_data.get('weight') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE player_profile SET weight=? WHERE player_id='" + str(player_id) + "'", ([put_data['nickname']]))
                    conn.commit()
            ...
            if incoming_data.get('previous_club') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET previous_club='" + str(player_id) + "'", ([put_data['previous_club']]))
                    conn.commit()
            ...
            if incoming_data.get('current_club') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET current_club=? WHERE player_id='" + str(player_id) + "'", ([put_data['current_club']]))
                    conn.commit()
            ...
            if incoming_data.get('player_description') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET player_description=? WHERE player_id='" + str(player_id) + "'", ([put_data['player_description']]))
                    conn.commit()
            ...
            if incoming_data.get('player_image') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE player_profile SET player_image=? WHERE player_id='" + str(player_id) + "'", ([put_data['player_image']]))
                    conn.commit()
        ...
        with sqlite3.connect('football.db') as conn:
            ...
            if incoming_data.get('firstname') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE scouter_profile SET firstname=? WHERE scouter_id='"+ str(scouter_id) + "'",([put_data['firstname']]))
                    conn.commit()
                    response['message'] = "First Name Updated Successfully"
                    response['status_code'] = 200
                    return response
            ...
            if incoming_data.get('lastname') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE scouter_profile SET lastname=? WHERE scouter_id=' "+ str(scouter_id) + "'", ([put_data['lastname']]))
                    conn.commit()
                    response['message'] = "lastname Updated Successfully"
                    response['status_code'] = 200
                    return response
            ...
            if incoming_data.get('email') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE scouter_profile SET email=? WHERE scouter_id='"+ str(scouter_id) + "'", ([put_data['email']]))
                    conn.commit()
                    response['message'] = "email Updated Successfully"
                    response['status_code'] = 200
                    return response
            ...
            if incoming_data.get('phone') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE scouter_profile SET phone=? WHERE scouter_id='"+ str(scouter_id) +"'", ([put_data['phone']]))
                    conn.commit()
            ...
            if incoming_data.get('age') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE scouter_profile SET age=? WHERE scouter_id=' " + str(scouter_id) + "'", ([put_data['age']]))
                    conn.commit()
                    response['message'] = "age  Updated Successfully"
                    response['status_code'] = 200
                return response
            ...
            if incoming_data.get('nationality') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute("UPDATE scouter_profile SET nationality=? WHERE scouter_id=' " + str(scouter_id) + "'", ([put_data['nationality']]))
                    conn.commit()
            ...
            if incoming_data.get('image') is not None:
                ...
                with sqlite3.connect('football.db') as conn:
                    cursor = conn.cursor()
                    cursor.execute(
                        "UPDATE scouter_profile SET image=? WHERE scouter_id=' " + str(scouter_id) + "'", ([put_data['image']]))
                    conn.commit()
...
def view_player_profile(player_id):
    ...
    with sqlite3.connect('football.db') as conn:
        conn.row_factory = dict_factory
        cursor = conn.cursor()
        cursor.execute("SELECT * FROM player_profile WHERE player_id= " + str(player_id))
